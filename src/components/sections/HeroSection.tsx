    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 overflow-hidden relative">
      ...
      <div className="section-container z-10">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-2xl">{tagline}</p>
          ...
          <div className="flex space-x-6">
            <a 
              ...
              className="animate-float text-foreground/70 hover:text-primary transition-colors"
              aria-label="GitHub"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="animate-float delay-100 text-foreground/70 hover:text-primary transition-colors"
              aria-label="LinkedIn"
            >
            ...
            {socialLinks.kaggle && (
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="animate-float delay-150 text-foreground/70 hover:text-primary transition-colors"
                aria-label="Kaggle"
              >
                <svg 
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="animate-float delay-200 text-foreground/70 hover:text-primary transition-colors"
              aria-label="Email"
            >
      ...
      <div className="absolute right-10 top-1/2 transform -translate-y-1/2 hidden md:block">
        <img 
          ...
          alt="Tech Stack" 
          className="w-64 lg:w-80 animate-float opacity-90" 
        />
      </div>
    </section>
  );
